...
func IsInteractiveTerminal() bool {
	...
	// Avoid interactive mode when stdin/stdout are attached to different streams
	// (for example piping output through another command).
	return os.SameFile(stdinInfo, stdoutInfo)
}
