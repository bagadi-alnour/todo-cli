...
LD_FLAGS="-X=github.com/bagadi-alnour/todo-cli/internal/cmd.Version=$VERSION -X=github.com/bagadi-alnour/todo-cli/internal/cmd.BuildDate=$BUILD_DATE -X=github.com/bagadi-alnour/todo-cli/internal/cmd.Commit=$COMMIT"
